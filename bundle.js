...
var app = new __WEBPACK_IMPORTED_MODULE_0_vue___default.a({
	...
	methods:{
		...
		getCurUser:function(){
			let cur = __WEBPACK_IMPORTED_MODULE_1_leancloud_storage___default.a.User.current();
			if(cur){
		...
		saveTodos:function () {
			...
			var AvTodo = __WEBPACK_IMPORTED_MODULE_1_leancloud_storage___default.a.Object.extend("AllTodos");
